...
> Python client SDK for interacting with the core inference API - part of the [SynapseBase](https://github.com/SynapseBase) open-source ecosystem.
...
The `sdk` package provides the Python interface for integrating with SynapseBase's infrastructure, designed for ease of use in both scripts and production services.
...
```bash
git clone https://github.com/SynapseBase/sdk
cd sdk
pip install -e .
```
